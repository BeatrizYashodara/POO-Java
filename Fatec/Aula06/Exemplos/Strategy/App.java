publc class App{
  ...
  public static void main(String[] args) {
    ...
    double distancia = 100.00; // Distância de 100km para o teste
    ...
    System.out.println("O valor do frete Normal para %.1fkm é: R$ %.2f%n", distancia, valorNormal);

    //3. Usando a calculadora com a estratégia de Frete Expresso
    double valorExpresso = calculadora.calculaFrete(freteExpresso,distancia);
    System.out.println("O valor do frete Expresso para %.1fkm é: R$ %.2f%n", distancia, valorExpresso);
    ...
    System.out.println("O valor do frete por Retirada para %.1fkm é: R$ %.2f%n", distancia, valorNormal);
